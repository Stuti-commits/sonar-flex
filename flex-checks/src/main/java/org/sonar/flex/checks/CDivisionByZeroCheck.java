...
public class CDivisionByZeroCheck extends FlexCheck {
    ...
    private static boolean isZeroLiteral(AstNode node) {
        ...
        if (current.is(FlexGrammar.C_PRIMARY_EXPR)) {
        ...
        if (current.is(FlexGrammar.C_CONSTANT)) {
